...
#Splitting training data to 75:25 percent training and validation dataset
intrain <- createDataPartition(y = tr$classe, p = 0.75, list = F)
training <- tr[intrain,]
validate <- tr[-intrain,]
